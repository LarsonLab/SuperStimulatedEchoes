...
mets(5).name = 'lac'; mets(5).f = 165; mets(5).df = 1.*df; mets(5).ang = flipall;mets(5).d = .04;

mets(4).name = 'pyrh'; mets(4).f = 40; mets(4).df = 1*df; mets(4).ang = flipall; mets(4).d = .01;

mets(3).name = 'ala'; mets(3).f = -45; mets(3).df = 1.*df; mets(3).ang = flipall; mets(3).d = .04;
...
% pi/2 phase for pyrh
mets(4).phs = mod(pi/2-2*pi*(mets(4).f - mets(2).f) * TE/2,2*pi)-pi; mets(4).dphs=dphsall;

% pi/2 for lac/ala
mets(5).phs = mod(-pi/2 - 2*pi*(mets(5).f - mets(2).f) * TE/2,2*pi)-pi;  mets(5).dphs=dphsall*4;
mets(3).phs = mod(-pi/2 - 2*pi*(mets(3).f - mets(2).f) * TE/2,2*pi)-pi;  mets(3).dphs=dphsall*4;
